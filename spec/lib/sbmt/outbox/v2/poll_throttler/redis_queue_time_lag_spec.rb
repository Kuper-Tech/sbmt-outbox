...
describe Sbmt::Outbox::V2::PollThrottler::RedisQueueTimeLag do
  ...
  it "waits if lag is less than min_lag" do
    ...
    expect { throttler.call(0, task, nil) }
      .to increment_yabeda_counter(Yabeda.box_worker.poll_throttling_counter).with_tags(status: "throttle", throttler: "Sbmt::Outbox::V2::PollThrottler::RedisQueueTimeLag", name: "inbox_item", type: :inbox, worker_name: "poller", worker_version: 2).by(1)
